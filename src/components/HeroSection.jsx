...
import heroImage from '../assets/hero.jpg'; // Replace with your actual image
    ...
    <section className="text-gray-700 body-font ">
      <div className="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pr-16 md:pr-12 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-5xl text-4xl mb-4 font-bold text-blue">
            Elevate Your Shopping Experience
            <br className="hidden lg:inline-block" />
            with Premium Products
          </h1>
          <p className="mb-8 leading-relaxed text-blue text-lg ">
